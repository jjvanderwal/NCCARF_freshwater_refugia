...
image.dir = "/home/jc246980/ALA_downloads/Distribution_Images/Misc_distributions"          #location of images
miscdata.dir = "/home/jc246980/ALA_downloads/Data/Misc"   #location of ALA files
...
species=list.files(miscdata.dir)
...
for (sp in 1:length(species)) { cat(species[sp],'\n')
      ...
      if(file.exists(paste(miscdata.dir, '/',species[sp],sep=''))){
              species.data.ala = read.csv(paste(miscdata.dir, '/',species[sp],sep=''))
