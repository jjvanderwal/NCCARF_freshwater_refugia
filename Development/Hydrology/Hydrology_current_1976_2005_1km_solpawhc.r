####################################################################################
##### run Budyko code simply providing matrix 12xn where columns represent 12 months -- static analysis at 1km using solpawhc
...
pos$PAWHC = extract.data(cbind(pos$lon,pos$lat),read.asc('inputs/solpawhc_1km.asc')) #append data to pos
...
if (outname=='current_1km_solpawhc') {
