...
wd=paste('/home/jc165798/working/NARP_FW_SDM/models_fish/',spp,'/output/WT_realized/',sep=''); setwd(wd) #set working directory
out.dir=paste('/home/jc165798/working/NARP_FW_SDM/models_fish/',spp,'/output/asciis/WT_realized/',sep='')
