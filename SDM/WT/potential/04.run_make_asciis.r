...
wd=paste('/home/jc148322/NARPfreshwater/SDM/models/',spp,'/output/WT_potential/',sep=''); setwd(wd) #set working directory
...
out.dir=paste('/home/jc148322/NARPfreshwater/SDM/models/',spp,'/output/asciis/WT_potential/',sep='')
